...
l3fwd_path = '/nethome/acho44/zsim/my_l3fwd/build_2/l3fwd'
...
if '1' in printstd:
    os.system('timeout 2h ./zsim conf.cfg')
else:
    os.system('timeout 2h ./zsim conf.cfg 1> res.txt 2>app.txt')
#os.system('ipcrm -a')
#os.system('./zsim conf.cfg 1> res.txt 2>app.txt')
#os.system('python3 ../process_zsim_out.py')
#os.system('python3 ../process_timestamps.py')
#os.system('../process_skew.py')
os.system('../pzo_gml.py')
os.system('cd ..')
