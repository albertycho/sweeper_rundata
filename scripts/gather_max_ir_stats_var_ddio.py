...
parser.add_argument('--out_file', type=str, default='max_ir_stats_0419_l3f_12C_512BP_var_ddio.csv')
...
regress_pre = '/shared/acho44/0419_l3fwd_xmem_varddio_12C_512BP_BATCH/'
        ...
        for mc in memconts:
            for ds in ddio_setups:
                for dw in ddio_ways:
                    ...
                    target_path = regress_pre + str(ps)+'pack_'+str(rbc)+'recv_'+mc+'_batch_32'+ds+'_'+dw+'ways/max_IR_stat.csv'
                    #print (target_path)
                    ...
                    if os.path.isfile(target_path):
                        ...
                        f1.write(ps+'pack_'+rbc+'recv_'+mc+'_'+ds+'_'+dw+',')
