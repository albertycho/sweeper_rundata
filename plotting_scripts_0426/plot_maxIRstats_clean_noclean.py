...
parser.add_argument('--infile', type=str, default='max_ir_stats_0321_l3f_noclean.csv')  
parser.add_argument('--infile2', type=str, default='max_ir_stats_0321_l3f_clean.csv')  
...
clean_setups=[]
clean_setups.append(clean_setups_6mc)
clean_setups.append(clean_setups_3mc)
clean_setups.append(clean_setups_2mc)
clean_setups.append(clean_setups_simp)
clean_setups.append(clean_setups_ideal)
clean_max_ir=[]
clean_max_ir.append(clean_max_ir_6mc)
clean_max_ir.append(clean_max_ir_3mc)
clean_max_ir.append(clean_max_ir_2mc)
clean_max_ir.append(clean_max_ir_simp)
clean_max_ir.append(clean_max_ir_ideal)
...
clean_mbw_ideal=[]
clean_mbw = []
clean_mbw.append(clean_mbw_6mc)
clean_mbw.append(clean_mbw_3mc)
clean_mbw.append(clean_mbw_2mc)
clean_mbw.append(clean_mbw_simp)
clean_mbw.append(clean_mbw_ideal)
...
clean_avg_st_ideal=[]
clean_avg_st = []
clean_avg_st.append(clean_avg_st_6mc)
clean_avg_st.append(clean_avg_st_3mc)
clean_avg_st.append(clean_avg_st_2mc)
clean_avg_st.append(clean_avg_st_simp)
clean_avg_st.append(clean_avg_st_ideal)
...
clean_avg_e2e =[]
clean_avg_e2e.append(clean_avg_e2e_6mc)
clean_avg_e2e.append(clean_avg_e2e_3mc)
clean_avg_e2e.append(clean_avg_e2e_2mc)
clean_avg_e2e.append(clean_avg_e2e_simp)
clean_avg_e2e.append(clean_avg_e2e_ideal)
...
clean_nic_rb_mr_2mc=[]
clean_nic_rb_mr_3mc=[]
clean_nic_rb_mr_simp=[]
clean_nic_rb_mr_ideal=[]
clean_nic_rb_mr=[]
clean_nic_rb_mr.append(clean_nic_rb_mr_6mc)
clean_nic_rb_mr.append(clean_nic_rb_mr_3mc)
clean_nic_rb_mr.append(clean_nic_rb_mr_2mc)
clean_nic_rb_mr.append(clean_nic_rb_mr_simp)
clean_nic_rb_mr.append(clean_nic_rb_mr_ideal)
...
clean_wr_lat_ideal=[]
clean_wr_lat=[]
clean_wr_lat.append(clean_wr_lat_6mc)
clean_wr_lat.append(clean_wr_lat_3mc)
clean_wr_lat.append(clean_wr_lat_2mc)
clean_wr_lat.append(clean_wr_lat_simp)
clean_wr_lat.append(clean_wr_lat_ideal)
...
clean_rd_lat_ideal=[]
clean_rd_lat=[]
clean_rd_lat.append(clean_rd_lat_6mc)
clean_rd_lat.append(clean_rd_lat_3mc)
clean_rd_lat.append(clean_rd_lat_2mc)
clean_rd_lat.append(clean_rd_lat_simp)
clean_rd_lat.append(clean_rd_lat_ideal)

clean_nic_lb_mr=[]
clean_ddio_ways_mr=[]
clean_non_ddio_ways_mr=[]




if infile2 in os.listdir('.'):
    f2=open(infile2,'r')
    line=f2.readline();
    field_names=line.split(',')
    print(str(len(field_names)))
    ...
    while line:
        ...
        rdlat_in_ns = float(tmp[11])*0.4
        if '6' in cons:
            clean_setups_6mc.append(su)
            clean_max_ir_6mc.append(ir_in_Gbps)
            clean_mbw_6mc.append(float(tmp[2]))
            clean_avg_st_6mc.append(st_in_ns)
            clean_avg_e2e_6mc.append(avg_e2e_in_ns)
            clean_nic_rb_mr_6mc.append(float(tmp[6]))
            clean_wr_lat_6mc.append(wrlat_in_ns)
            clean_rd_lat_6mc.append(rdlat_in_ns)

        if '2' in cons:
            clean_setups_2mc.append(su)
            clean_max_ir_2mc.append(ir_in_Gbps)
            clean_mbw_2mc.append(float(tmp[2]))
            clean_avg_st_2mc.append(st_in_ns)
            clean_avg_e2e_2mc.append(avg_e2e_in_ns)
            clean_nic_rb_mr_2mc.append(float(tmp[6]))
            clean_wr_lat_2mc.append(wrlat_in_ns)
            clean_rd_lat_2mc.append(rdlat_in_ns)


        if '3' in cons:
            clean_setups_3mc.append(su)
            clean_max_ir_3mc.append(ir_in_Gbps)
            clean_mbw_3mc.append(float(tmp[2]))
            clean_avg_st_3mc.append(st_in_ns)
            clean_avg_e2e_3mc.append(avg_e2e_in_ns)
            clean_nic_rb_mr_3mc.append(float(tmp[6]))
            clean_wr_lat_3mc.append(wrlat_in_ns)
            clean_rd_lat_3mc.append(rdlat_in_ns)



        if 'simp' in cons:
            clean_setups_simp.append(su)
            clean_max_ir_simp.append(ir_in_Gbps)
            clean_mbw_simp.append(float(tmp[2]))
            clean_avg_st_simp.append(st_in_ns)
            clean_avg_e2e_simp.append(avg_e2e_in_ns)
            clean_nic_rb_mr_simp.append(float(tmp[6]))
            clean_wr_lat_simp.append(float(tmp[10])) #these two will be 0 for simp
            clean_rd_lat_simp.append(float(tmp[11]))

        if 'ideal' in cons:
            clean_setups_ideal.append(su)
            clean_max_ir_ideal.append(ir_in_Gbps)
            clean_mbw_ideal.append(float(tmp[2]))
            clean_avg_st_ideal.append(st_in_ns)
            clean_avg_e2e_ideal.append(avg_e2e_in_ns)
            clean_nic_rb_mr_ideal.append(float(tmp[6]))
            clean_wr_lat_ideal.append(wrlat_in_ns) 
            clean_rd_lat_ideal.append(rdlat_in_ns)
...
clean_arrptr=[]
clean_arrptr.append(clean_max_ir)
clean_arrptr.append(clean_mbw)
clean_arrptr.append(clean_avg_st)
clean_arrptr.append(clean_avg_e2e)
clean_arrptr.append(clean_e2e_90)
clean_arrptr.append(clean_nic_rb_mr)
clean_arrptr.append(clean_nic_lb_mr)
clean_arrptr.append(clean_ddio_ways_mr)
clean_arrptr.append(clean_non_ddio_ways_mr)
clean_arrptr.append(clean_wr_lat)
clean_arrptr.append(clean_rd_lat)
print('clean_arrptr len: '+str(len(clean_arrptr)))
...
for i in {0,1,2,3,5,9 ,10}:
    ...
    #iax.bar(X_axis-0.25, arrptr[i][3],edgecolor='black', alpha=0.5, color="gray", label='simp', width=0.1)
    #iax.bar(X_axis-0.15, arrptr[i][4],edgecolor='black', alpha=0.5, color="black", label='ideal', width=0.1)
    iax.bar(X_axis-0.2, clean_arrptr[i][4],edgecolor='black', alpha=0.5, color="black", label='ideal', width=0.1)
    iax.bar(X_axis-0.1, arrptr[i][0],edgecolor='black', alpha=0.5, color="skyblue", label='6mc: 920Gbps', width=0.1)
    iax.bar(X_axis+0, clean_arrptr[i][0],edgecolor='black', alpha=0.5, color="navy", label='6mc-clean', width=0.1)
    iax.bar(X_axis+0.1, arrptr[i][1],edgecolor='black', alpha=0.5, color="lime", label='3mc: 460Gbps', width=0.1)
    iax.bar(X_axis+0.2, clean_arrptr[i][1],edgecolor='black', alpha=0.5, color="darkgreen", label='3mc-clean', width=0.1)
    iax.bar(X_axis+0.3, arrptr[i][2],edgecolor='black', alpha=0.5, color="salmon", label='2mc: 307Gbps', width=0.1)
    iax.bar(X_axis+0.4, clean_arrptr[i][2],edgecolor='black', alpha=0.5, color="darkred", label='2mc-clean', width=0.1)
