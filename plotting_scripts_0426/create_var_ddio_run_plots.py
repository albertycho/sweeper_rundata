...
for ps in packet_sizes:
    ...
    #os.system('grep -ir "1024pack_'+ps+'recv" '+infile+'> '+ps+'/'+ps+'_stats.csv')
    os.system('grep -ir "pack_'+ps+'recv" '+infile+'> '+ps+'/'+ps+'_stats.csv')
    #os.system('cd '+ps)
    os.chdir(ps)
    print(os.getcwd())
    #os.system('~/INDIE/plot_maxIRstats_partition_IR_AND_IPC.py --infile '+ps+'_stats.csv')
    os.system('../../plot_maxIRstats_var_ddio_IR_AND_IPC.py --infile '+ps+'_stats.csv')
    #print('~/INDIE/plot_maxIRstats_partition_IR_AND_IPC.py --infile '+ps+'_stats.csv')
    os.system('~/INDIE/plot_maxIRstats_var_ddio.py --infile '+ps+'_stats.csv')
    #os.system('cd ..')
    os.chdir(curdir)
