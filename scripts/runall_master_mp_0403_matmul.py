            ...
            for mc in mcs:
                for bs in batchsizes: #just keeping the name convention
                    ...
                    tmpcmd = batch_script_name+' --base_cfg '+base_cfg_name+\
                            ...
                            ' --batch_dir '+output_path_base+str(ps)+'pack_'+str(rbc)+'recv_'+mc+'_batch_'+bs+ds+'ways'+' --num_keys '+num_keys+' --matN 450 '
